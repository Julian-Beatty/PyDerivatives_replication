######################Pyderivatives is required to run this replication folder. Install at https://github.com/Julian-Beatty/PyDerivatives_replication. 
...
if cwd.name == "Replication Folder":
    ...
    raise ValueError("Working directory is not 'Replication Folder', Change working directory to Replication Folder.")
